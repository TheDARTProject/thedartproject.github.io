            ...
            <div class="flex flex-col gap-6 flex-1">
                ...
                <div class="bg-gray-50 p-2 rounded-lg">
                    ...
                    <div class="flex items-center gap-2">
                        ...
                        <div class="relative flex-shrink-0">
                            <div class="blur-container relative overflow-hidden rounded-full">
                                <img src="https://cdn.discordapp.com/avatars/${server.INVITE_CREATOR.USER_ID}/${server.INVITE_CREATOR.AVATAR}.png?size=256"
                                      ...
                                      data-blurred="true"
                                      onerror="this.src='https://raw.githubusercontent.com/ThatSINEWAVE/CDA-Project/refs/heads/main/docs/images/site-images/UNKNOWN-USER.png'; this.classList.remove('blur-xl'); this.parentElement.querySelector('.nsfw-warning').classList.add('hidden')">
                        ...
                        <img src="https://raw.githubusercontent.com/ThatSINEWAVE/CDA-Project/refs/heads/main/docs/images/site-images/UNKNOWN-USER.png"
                              alt="No avatar"
