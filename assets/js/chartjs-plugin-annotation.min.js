...
! function(t, e) {
    ...
    function T(t, o, n) {
        ...
        t.save(), t.textBaseline = "middle", t.textAlign = n.textAlign,
            function(t, e) {
    ...
    function _(t, e) {
        const {
            chartArea: o,
            scales: n
        } = t, r = n[E(n, e, "xScaleID")], i = n[E(n, e, "yScaleID")];
        let s = o.width / 2,
            a = o.height / 2;
    ...
    function nt(t, o) {
        ...
        const n = o.charAt(0);
        for (const o of ["Min", "Max", "Value"])
            if (e.defined(t[n + o])) return !0;
        return !1
    }
        ...
        draw(t) {
            ...
            o.display && o.content && n && (t.save(), D(t, this.getCenterPoint(), this.rotation), function(t, o) {
                const {
                    ...
                    pointY: r,
                    options: i
                } = o, s = i.callout, a = s && s.display && function(t, o) {
                    const n = o.position;
                    ...
                    return function(t, o) {
                        const {
                            ...
                            x: h,
                            y: u
                        }, y = o.start, p = b(a, y), g = b(d, y), m = [n, n + p, n + p, i], v = [r + g, s, r, s], w = [];
                        for (let t = 0; t < 4; t++) {
                            const o = $({
                                x: m[t],
                                y: v[t]
                            ...
                            w.push({
                                position: st[t],
                                distance: e.distanceBetweenPoints(o, {
                                    x: c,
                                    y: l
                                })
                            })
                ...
                const {
                    ...
                    const {
                        ...
                        height: i,
                        options: s
                    } = t, a = s.callout.start, d = function(t, e) {
                        const o = e.side;
            ...
            }(t, this), O(t, this, o), T(t, function({
                x: t,
                y: o,
                width: n,
                height: r,
        ...
        inRange(t, e, o, n) {
            ...
            if ("x" !== o && "y" !== o) {
                ...
                if (i) {
                    ...
                    const {
                        chart: r
                    } = this.$context, s = t * r.currentDevicePixelRatio, d = e * r.currentDevicePixelRatio, c = a.isPointInStroke(i, s, d) || wt(this, o, n);
                    return a.restore(), c
                }
                return function(t, {
                    mouseX: e,
                    ...
                    const {
                        ...
                        x2: d,
                        y2: c
                    } = t.getProps(["x", "y", "x2", "y2"], r), l = d - i, h = c - a, u = ut(l) + ut(h), f = 0 === u ? -1 : ((e - i) * l + (o - a) * h) / u;
                    let x, y;
        ...
        draw(t) {
            ...
            if (a.curve && s) return function(t, o, n, r) {
                const {
                    ...
                    x: a,
                    y: d
                }, p = bt(x, n, y, 0), b = bt(x, n, y, 1) - e.PI, g = yt(x, n, y, u / r), m = yt(x, n, y, 1 - f / r), v = new Path2D;
            ...
            if (c.centerX = (s + r) / 2, c.centerY = (a + i) / 2, c.initProperties = v(t, c, o), o.curve) {
                ...
                c.cp = function(t, e, o) {
                    const {
                        ...
                        centerX: a,
                        centerY: d
                    } = t, c = Math.atan2(s - r, i - n), l = g(e.controlPoint, 0);
                    return $({
                        x: a + b(o, l.x, !1),
                        y: d + b(o, l.y, !1)
                    }, {
                    ...
                    const {
                        ...
                        const i = function(t, e) {
                            const {
                                ...
                                y: r,
                                y2: i
                            } = t, s = Math.min(r, i) - e.top, a = Math.min(o, n) - e.left, d = e.bottom - Math.max(r, i), c = e.right - Math.max(o, n);
                            return {
                                x: Math.min(a, c),
                                y: Math.min(s, d),
                                dx: a <= c ? 1 : -1,
                        ...
                        labelSize: f,
                        padding: a
                    }, r), y = t.cp ? yt(l, t.cp, h, x) : ct(l, h, x), b = {
                        size: f.w,
                        min: r.left,
                        max: r.right,
                        padding: a.left
    ...
    function Mt(t, e, o, n) {
        const {
            labelSize: r,
            padding: i
        } = e, s = t.w * n.dx, d = t.h * n.dy, c = s > 0 && (r.w / 2 + i.left - n.x) / s, l = d > 0 && (r.h / 2 + i.top - n.y) / d;
    ...
    class At extends t.Element {
        inRange(t, o, n, r) {
            ...
            const {
                ...
                x2: l,
                y2: h
            } = this.getProps(["x", "y", "x2", "y2"], r), u = a / 2, f = "y" === n ? {
                start: c,
                end: h
            } : {
                start: d,
    ...
    class jt extends t.Element {
        inRange(t, e, o, n) {
            const {
                ...
                y2: a,
                width: d
            } = this.getProps(["x", "y", "x2", "y2", "width"], n), c = this.options.borderWidth;
    ...
    var Ut = {
        ...
        afterUpdate(t, o, r) {
            ...
            }(0, i, r), _t(t, i, r, o.mode), i.visibleElements = i.elements.filter((t => !t.skip && t.options.display)),
                function(t, o, n) {
    ...
    function Jt(t, o, n) {
        ...
        const a = function(t, e) {
            const o = [];
            for (const n of t)
                if (n.options.drawTime === e && o.push({
                        element: n,
                        main: !0
                    }), n.elements && n.elements.length)
                    for (const t of n.elements) t.options.display && t.options.drawTime === e && o.push({
                        element: t
                    });
            return o
